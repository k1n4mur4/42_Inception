...
info:
	...
	@printf "\033[1;94mCOMPOSE_FLAG \033[1;94m:| \033[0m$(COMPOSE_FLAGS)\n"
...
setup:
	...
	@printf "\033[1;92mData directories ready: $(DATA_DIR)\033[0m\n"

#? Build services
.ONESHELL:
build: setup
	@$(QUIET) || printf "\033[1;92mBuilding images\033[37m...\033[0m\n"
	@$(VERBOSE) || printf "$(COMPOSE) $(COMPOSE_FLAGS) $(COMPOSE_FILE) build\n"
	@$(COMPOSE) $(COMPOSE_FLAGS) $(COMPOSE_FILE) build || exit 1
...
up:
	...
	@$(VERBOSE) || printf "$(COMPOSE) $(COMPOSE_FLAGS) $(COMPOSE_FILE) up -d\n"
	@$(COMPOSE) $(COMPOSE_FLAGS) $(COMPOSE_FILE) up -d $(SUPPRESS) || exit 1
	@$(COMPOSE) $(COMPOSE_FLAGS) $(COMPOSE_FILE) ps $(SUPPRESS) || true
...
#? Follow logs
logs:
	@$(COMPOSE) $(COMPOSE_FLAGS) $(COMPOSE_FILE) logs -f

#? Show status
status:
	@printf " $(BANNER)\n"
	@$(COMPOSE) $(COMPOSE_FLAGS) $(COMPOSE_FILE) ps
